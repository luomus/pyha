...
# 'https://fmnh-ws-test.it.helsinki.fi/pyha/'
PYHA_URL = os.environ["PYHA_URL"]
# 'https://fmnh-ws-test.it.helsinki.fi/laji-auth/'
LAJIAUTH_URL = os.environ["LAJI_AUTH_URL"]
# 'https://fmnh-ws-test.it.helsinki.fi/laji-etl/download/secured/'
LAJIDOW_URL = os.environ["LAJI_ETL_FILE_DOWNLOAD_URL"]
# 'https://fmnh-ws-test.it.helsinki.fi/triplestore/'
LAJIPERSONAPI_URL = os.environ["TRIPLESTORE_URL"]
...
# 'https://beta.laji.fi/observation/map?'
FILTERS_LINK = os.environ["OBSERVATION_LINK_PREFIX"]
...
SEND_AUTOMATIC_HANDLER_MAILS = os.environ.get(
    "SEND_AUTOMATIC_HANDLER_MAILS", "False") == "True"
