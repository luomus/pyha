...
urlpatterns = [
    ...
    url(r'^groupdeleterequest/?$', index.group_delete_request,
        name='group_delete_request'),
    url(r'^logout/?$', logout.logout, name='logout'),
    url(r'^settings/?$', usersettings.usersettings, name='usersettings'),
    url(r'^ajax/getCollection/?$', ajax.get_collection_ajax,
        name='get_collection_ajax'),
    url(r'^ajax/getSummary/?$', ajax.get_summary_ajax, name='get_summary_ajax'),
    url(r'^ajax/createContact/?$', ajax.create_contact_ajax,
        name='create_contact_ajax'),
    url(r'^ajax/removeCollection/?$', ajax.remove_collection_ajax,
        name='remove_collection_ajax'),
    url(r'^ajax/getDescription/?$', ajax.get_description_ajax,
        name='get_description_ajax'),
    url(r'^ajax/setDescription/?$', ajax.set_description_ajax,
        name='set_description_ajax'),
    url(r'^ajax/getRequestList/?$', index.get_request_list_ajax,
        name='get_request_list_ajax'),
    url(r'^approve/?$', requestform.approve_terms, name='approve'),
    url(r'^request/[1-9][0-9]*/?$',
        requestview.show_request, name='show_request'),
    url(r'^description/?$', requestview.change_description,
    ...
    url(r'^initializeDownload/?$', requestview.initialize_download,
        name='initializeDownload'),
    url(r'^downloadLink/?$', ajax.download_link, name='requestDownload'),
    url(r'^gisDownloadStatus/(?P<download_id>[^/]+)/?$',
        ajax.gis_download_status, name='gis_download_status'),
    url(r'^saveUserSettings/?$', usersettings.save_user_settings,
        name='save_user_settings'),
    url(r'^savePyhaSettings/?$', usersettings.save_pyha_settings,
        name='save_pyha_settings'),
    ...
    url(r'^{0}/?$'.format(settings.SECRET_STATUS_SUB_DIR),
        api.status, name='status'),
    url(r'^role/?$', logout.change_role, name='change_role'),
    url(r'^freezeRequest/?$', requestview.freeze, name='freeze'),
    url(r'^refreshCollectionsCache/?$', requestview.refresh_collections_cache,
        name='refresh_collections_cache'),
