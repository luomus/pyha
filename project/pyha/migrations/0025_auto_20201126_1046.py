# Generated by Django 3.0.2 on 2020-11-26 10:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='action',
            field=models.CharField(choices=[('VIEW', 'views request'), ('SUB', 'submits request'), ('ACC', 'accepts terms of use'), ('POS', 'accepts use of data'), ('POSOV', 'accepted use of data, because decision has been overdue'), ('RESET', 'resets the decision regarding data'), ('NEG', 'declines use of data'), ('NEGOV', 'declines use of data, because decision has been overdue')], max_length=5),
        ),
        migrations.AlterField(
