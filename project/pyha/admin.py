...
class RequestLogEntryAdmin(SimpleHistoryAdmin):
    search_fields = ['request__id', 'collection',
                     'date', 'user', 'role', 'action']
    history_list_display = ["changedBy"]
...
class LogEntryAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('change_message', 'content_type', 'user',
                       'action_time', 'object_repr', 'action_flag', 'object_id')
...
admin.site.register(RequestInformationChatEntry,
                    RequestInformationChatEntryAdmin)
